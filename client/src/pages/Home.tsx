...
>
  <div className="container mx-auto px-6 max-w-5xl">
    <h2 className="text-5xl font-bold mb-12 text-gradient glow text-center">PUBLICATIONS &#123;</h2>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-6">
        <div>
          ...
          <p className="text-foreground/80 mb-4">
            IEEE Conference on Networking, Embedded and Wireless Systems (ICNEWS)
          </p>
          <p className="text-foreground/70 leading-relaxed mb-4">
            Published a novel RIS-assisted wireless communication framework using DeepMIMO and AlexNet-based deep
            learning models. Proposed optimized RIS phase configurations for urban environments, reducing training
            overhead by 86% and achieving significantly improved data rate performance.
          </p>
          <div className="flex flex-wrap gap-2 mb-4">
            {["Deep Learning", "RIS", "Wireless Communication", "TensorFlow", "MATLAB", "DeepMIMO"].map(
              (tag, idx) => (
                <span
                  key={idx}
          ...
          <a
            href="https://ieeexplore.ieee.org/document/10731107"
            target="_blank"
